...
import { capitalize, actionTypes } from '../../utils/utils';
...
export default function SignUp({ setAlert, dispatchAction }) {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Container maxWidth='xs'>
                    ...
                    <Grid container justify="flex-end">
                        <Grid item>
                            <Link href="#" variant="body2" onClick={() => { dispatchAction(actionTypes.login); setAlert({}) }}>
